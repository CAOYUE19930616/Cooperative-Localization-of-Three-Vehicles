...
% %  Update other
  ...
  %% 
  % Exchanged states can be used as observations by the receiving vehicle
  % (Ycom = Xcom ---> Third observation model).
  
      if ~isnan(blue.Y_blue(:,k))
          [Xbb, Pbb] = KF_update(Xbb, Pbb, Xgb, Pgb, @g_gnss, @gC_gnss);
          [Xbb, Pbb] = KF_update(Xbb, Pbb, Xgw, Pgw, @g_gnss, @gC_gnss);
          [Xbb, Pbb] = KF_update(Xbb, Pbb, Xwb, Pwb, @g_gnss, @gC_gnss);
          [Xbb, Pbb] = KF_update(Xbb, Pbb, Xwg, Pwg, @g_gnss, @gC_gnss);
      end

    
%     if ~isnan(grey.Y_grey(:,k))
%         [Xgg, Pgg] = KF_update(Xgg, Pgg, Xbg, Pbg, @g_gnss, @gC_gnss);
%         [Xgg, Pgg] = KF_update(Xgg, Pgg, Xbw, Pbw, @g_gnss, @gC_gnss);
%         [Xgg, Pgg] = KF_update(Xgg, Pgg, Xwb, Pwb, @g_gnss, @gC_gnss);
%         [Xgg, Pgg] = KF_update(Xgg, Pgg, Xwg, Pwg, @g_gnss, @gC_gnss);
%     end

   
   if ~isnan(white.Y_white(:,k))
      [Xww, Pww] = KF_update(Xww, Pww, Xbg, Pbg, @g_gnss, @gC_gnss);
      [Xww, Pww] = KF_update(Xww, Pww, Xbw, Pbw, @g_gnss, @gC_gnss);
      [Xww, Pww] = KF_update(Xww, Pww, Xgb, Pgb, @g_gnss, @gC_gnss);
      [Xww, Pww] = KF_update(Xww, Pww, Xgw, Pgw, @g_gnss, @gC_gnss);
   end
