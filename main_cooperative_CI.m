...
%% Part 3 : Cooperative EK/CI Filter
...
%  % Update other
  ...
  %% Using of Covariance Intersection (CI) Update
  % The estimation and observation errors are NOT Independant ---> Use CI
  % to update the states.
  
    if ~isnan(blue.Y_blue(:,k))
          [Xbb, Pbb] = CI_update(Xbb, Pbb, Xgb, Pgb, @g_gnss, @gC_gnss);
          [Xbb, Pbb] = CI_update(Xbb, Pbb, Xgw, Pgw, @g_gnss, @gC_gnss);
          [Xbb, Pbb] = CI_update(Xbb, Pbb, Xwb, Pwb, @g_gnss, @gC_gnss);
          [Xbb, Pbb] = CI_update(Xbb, Pbb, Xwg, Pwg, @g_gnss, @gC_gnss);
    end

    
    if ~isnan(grey.Y_grey(:,k))
        [Xgg, Pgg] = CI_update(Xgg, Pgg, Xbg, Pbg, @g_gnss, @gC_gnss);
        [Xgg, Pgg] = CI_update(Xgg, Pgg, Xbw, Pbw, @g_gnss, @gC_gnss);
        [Xgg, Pgg] = CI_update(Xgg, Pgg, Xwb, Pwb, @g_gnss, @gC_gnss);
        [Xgg, Pgg] = CI_update(Xgg, Pgg, Xwg, Pwg, @g_gnss, @gC_gnss);
    end

   
   if ~isnan(white.Y_white(:,k))
      [Xww, Pww] = CI_update(Xww, Pww, Xbg, Pbg, @g_gnss, @gC_gnss);
      [Xww, Pww] = CI_update(Xww, Pww, Xbw, Pbw, @g_gnss, @gC_gnss);
      [Xww, Pww] = CI_update(Xww, Pww, Xgb, Pgb, @g_gnss, @gC_gnss);
      [Xww, Pww] = CI_update(Xww, Pww, Xgw, Pgw, @g_gnss, @gC_gnss);
   end
